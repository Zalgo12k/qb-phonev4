        ...
        if (CanOpenApp) {
            if (MI.Phone.Data.currentApplication == null) {
                ...
                if (PressedApplication == "settings") {
                    ...
                    $.post('http://qb-phone/GetCurrentDoctor', JSON.stringify({}), function(data){
                        SetupDoctor(data);
                    });
                    ...
                    $.post('http://qb-phone/GetCurrentMecano', JSON.stringify({}), function(data){
                        SetupMecano(data);
                        //SetupDrivers(data);
                    });	
                    
                } else if (PressedApplication == "weazel") {
                    $.post('http://qb-phone/GetCurrentWeazel', JSON.stringify({}), function(data){
                        SetupWeazel(data);
                        //SetupDrivers(data);
                    });	
                    ...
                    // console.log("policed")
                        $.post('http://qb-phone/GetCurrentpolices', JSON.stringify({}), function(data){
                            Setuppolices(data);
                        });					
                    } 
                }
