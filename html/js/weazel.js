SetupWeazel = function(data) {
    ...
    if (data.length > 0) {
        $.each(data, function(i, weazel){
            var element = '<div class="weazel-list" id="weazelid-'+i+'"> <div class="weazel-list-firstletter">' + (weazel.name).charAt(0).toUpperCase() + '</div> <div class="weazel-list-fullname">' + weazel.name + '</div> <div class="weazel-list-call"><i class="fas fa-phone"></i></div> </div>'
