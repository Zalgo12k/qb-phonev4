...
RegisterNUICallback("GetCurrentWeazel", function(data, cb)
    ESX.TriggerServerCallback('cash-telephone:server:GetCurrentWeazel', function(weazel)
        cb(weazel)
    end)
end)
...
RegisterNUICallback("GetCurrentFoodWorker", function(data, cb)
    ESX.TriggerServerCallback('cash-telephone:server:GetCurrentFoodWorker', function(workers)
        cb(workers)
    end, data.FoodJob)
end)
...
while takePhoto do
    ...
    if IsControlJustPressed(1, 27) then -- Toogle Mode
     ...
     exports['screenshot-basic']:requestScreenshotUpload('https://discord.com/api/webhooks/757368777917726770/iopo75BwIElEt4kmzGtZn6jMOuIgTaW6msQCGGyxmh1zyCsH1HzjanA9lRt4bt4hnuIm', 'files[]', function(data2)
        DestroyMobilePhone()
...
--     TriggerServerEvent("qb-phone:server:sendNewMail", { sender = "Ahmo G", subject = "Orospular!", message = "ananı sikiyim"})
-- end)